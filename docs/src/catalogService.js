/**
 * Pulse Music - 100% Exact Matching Audio & HD Studio Catalog
 */
  ...
  },
  {
    ...
    "tracks": [
      ...
      },
      {
        ...
        "stream": "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/e2/06/19/e2061998-6444-5c5b-5bfc-a149c55e2e2e/mzaf_10494977375651598168.plus.aac.p.m4a",
        "duration": 223
      },
      {
...
export async function fetchCategoryTracks(catId, limit = 50) {
  ...
  // 1. Add exact matching curated shelf tracks first
  ...
  if (found && found.tracks && found.tracks.length > 0) {
    found.tracks.forEach((t, idx) => {
      addTrack({
        ...
        source: `${found.title} (Featured Master)`
      });
    });
  }
