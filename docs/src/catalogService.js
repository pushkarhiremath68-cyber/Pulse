...
function getOfficialCover(title, artist) {
  ...
  const catalogService = {
    ...
    previewTrackSnippet(trackId, onStateChange = null) {
      ...
      previewAudioElement.play().then(() => {
        ...
        if (typeof window.showToast === 'function') {
          window.showToast(`ðŸŽ¶ 30s Snippet Preview: "${track.title}"`, 'info', 3000);
        }
    ...
    // =========================================================================
    // REAL-TIME SEARCH ENGINE (Local Catalog + Live Jamendo API)
    // =========================================================================
