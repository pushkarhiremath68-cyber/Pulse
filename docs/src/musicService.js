...
export async function fetchTrendingTracks(limit = 40) {
  ...
  if (results.length === 0) {
    const fallbackTracks = [
      ...
      { id: 'ytm-_dK2tDK9grQ', ytId: '_dK2tDK9grQ', title: 'Shape of You', artist: 'Ed Sheeran', coverUrl: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500&auto=format&fit=crop&q=80', duration: 233, source: 'Top Hit' },
