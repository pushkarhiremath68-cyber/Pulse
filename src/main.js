...
(function() {
  ...
  window.openLyricsForTrack = function(trackId) {
    ...
    if (modalArtist) modalArtist.textContent = `${track.artist || 'Artist'} â€¢ ${track.album || 'Single'}`;
    if (modal) modal.classList.remove('hidden');
        ...
        <div style="display: flex; align-items: center; gap: 1rem; flex: 1; min-width: 0;">
          ...
          <div style="min-width: 0;">
            ...
            <div style="font-size: 0.8rem; color: var(--text-secondary); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
              <span class="artist-clickable-link" onclick="event.stopPropagation(); window.openArtistProfile('${safeArtistEsc}')">${artist}</span> â€¢ ${track.album || 'Single'}
            </div>
          </div>
        </div>
  ...
  window.toggleTrackInPlaylist = function(plId, trackId) {
    ...
    if (idx > -1) {
      ...
      window.showToast?.(`Added "${track.title}" to "${pl.name}"! ðŸŽµ`, 'success', 2000);
    }
  ...
  window.toggleLikeTrack = function(track) {
    ...
    if (idx > -1) {
      ...
      window.showToast?.(`Added "${track.title}" to Liked Songs! â¤ï¸`, 'success', 2500);
    }
  ...
  async function startPlayback(track, initialSeekTime = null) {
    ...
    // 1. STOP ALL EXISTING AUDIO FIRST â€” strictly prevents double playback
    stopAllAudio();
  ...
  async function playTrackOnYouTubePlayer(videoIdOrQuery, autoPlay = true, parentSessionId = null) {
    ...
    if (targetId && ytPlayer && typeof ytPlayer.loadVideoById === 'function') {
      ...
      // Dynamic Search-To-Play Embed Player â€” Guarantees exact song matches without playing stale video
      if (ytPlayer && typeof ytPlayer.stopVideo === 'function') {
        try { ytPlayer.stopVideo(); } catch(e) {}
      }
  ...
  function generateThemedLyricsPreview(track, durSecs = 210) {
    ...
    if (lang.includes('kannada') || cat === 'kannada') {
      lines = [
        `[Intro: ${artist}]`,
        `â™ª ${title} - à²¸à³à²®à²§à³à²° à²§à³à²µà²¨à²¿ à²¤à²°à²‚à²— â™ª`,
        `à²®à²¨à²¦ à²®à³‚à²²à³†à²¯à²²à³à²²à²¿ à²¨à²¿à²¨à³à²¨à²¦à³‡ à²§à³à²¯à²¾à²¨`,
        `à²•à²£à³à²£à²¿à²¨ à²•à²¾à²‚à²¤à²¿à²¯à²²à²¿ à²¨à²¿à²¨à³à²¨à²¦à³‡ à²°à³‚à²ª`,
        `[Chorus]`,
        `${title} à²œà³Šà²¤à³†à²¯à²¾à²—à²¿ à²¸à²¾à²—à³à²µ à²ˆ à²ªà²¯à²£`,
        `à²¹à³ƒà²¦à²¯à²¦ à²®à²¾à²¤à³ à²¨à²¿à²¨à²—à²¾à²—à²¿ à²®à²¾à²¤à³à²°`,
        `à²ªà³à²°à³€à²¤à²¿à²¯ à²¤à²‚à²—à²¾à²³à²¿ à²¬à³€à²¸à²¿à²¦à³† à²‡à²‚à²¦à³`,
        `[Verse 1]`,
        `à²•à²¨à²¸à³à²—à²³ à²²à³‹à²•à²¦à²²à³à²²à²¿ à²¨à³€à²¨à³† à²¨à²—à³`,
        `à²¬à²¾à²³à²¿à²¨ à²¦à²¾à²°à²¿à²¯à²²à³à²²à²¿ à²¨à³€à²¨à³† à²¬à³†à²³à²•à³`,
        `[Bridge]`,
        `${title} à²¨à²¾à²¦ à²•à³‡à²³à³à²¤à²¿à²¦à³† à²Žà²²à³à²²à³†à²²à³à²²à³‚`,
        `[Outro: ${artist} - Album: ${album}]`,
        `â™ª à²­à²¾à²µà²¨à³†à²—à²³ à²¸à²¿à²¹à²¿ à²¸à²‚à²—à³€à²¤ à²ªà²¯à²£ â™ª`
      ];
    } else if (lang.includes('telugu') || cat === 'telugu') {
      lines = [
        `[Intro: ${artist}]`,
        `â™ª ${title} - à°®à°§à±à°°à°®à±ˆà°¨ à°¸à°‚à°—à±€à°¤à°‚ â™ª`,
        `à°¨à°¾ à°®à°¨à°¸à± à°¨à°¿à°¨à±à°¨à± à°•à±‹à°°à°¿à°‚à°¦à°¿ à°ˆ à°•à±à°·à°£à°¾à°¨`,
        `à°¨à±€ à°°à±‚à°ªà°®à±‡ à°¨à°¾ à°•à°¨à±à°¨à±à°² à°•à°¾à°‚à°¤à±à°²à±`,
        `[Chorus]`,
        `${title} à°¨à±€à°¤à±‹à°¨à±‡ à°¨à°¾ à°ªà±à°°à°¤à°¿ à°…à°¡à±à°—à±`,
        `à°—à±à°‚à°¡à±†à°²à±à°²à±‹ à°¦à°¾à°šà°¿à°¨ à°ªà±à°°à±‡à°® à°—à±€à°¤à°‚`,
        `à°¨à±€ à°¨à°µà±à°µà±à°² à°¤à±‹à°°à°£à°‚ à°¨à°¾ à°ªà±à°°à°¾à°£à°‚`,
        `[Verse 1]`,
        `à°•à°²à°²à°¨à±à°¨à±€ à°¨à°¿à°œà°®à±ˆ à°Žà°¦à±à°°à±Šà°šà±à°šà±†à°¨à± à°¨à±‡à°¡à±`,
        `à°¨à°¾ à°¦à°¾à°°à±à°²à°²à±‹ à°¨à±€ à°œà°¤ à°¤à±‹à°¡à±`,
        `[Bridge]`,
        `${title} à°°à°¾à°—à°‚ à°®à±à°°à±‹à°—à±†à°¨à± à°¨à°²à±à°µà±ˆà°ªà±à°²à°¾`,
        `[Outro: ${artist} - Album: ${album}]`,
        `â™ª à°…à°‚à°¤à±à°²à±‡à°¨à°¿ à°…à°¨à±à°°à°¾à°— à°ªà±à°°à°¯à°¾à°£à°‚ â™ª`
      ];
    } else if (lang.includes('tamil') || cat === 'tamil') {
      lines = [
        `[Intro: ${artist}]`,
        `â™ª ${title} - à®‡à®©à®¿à®¯ à®‡à®šà¯ˆà®ªà¯ à®ªà®¾à®Ÿà®²à¯ â™ª`,
        `à®Žà®©à¯ à®¨à¯†à®žà¯à®šà®¿à®²à¯ à®ªà¯‚à®¤à¯à®¤ à®ªà¯à®¤à¯ à®µà®šà®¨à¯à®¤à®®à¯`,
        `à®‰à®©à¯ à®µà®¿à®´à®¿à®•à®³à¯ à®ªà¯‡à®šà¯à®®à¯ à®†à®¯à®¿à®°à®®à¯ à®•à®¤à¯ˆà®•à®³à¯`,
        `[Chorus]`,
        `${title} à®‰à®©à¯à®©à¯‹à®Ÿà¯ à®µà®¾à®´à¯à®®à¯ à®‡à®¨à¯à®¤ à®µà®¾à®´à¯à®µà¯`,
        `à®•à®¾à®¤à®²à¯ à®•à®¾à®±à¯à®±à®¿à®²à¯ à®•à®²à®¨à¯à®¤ à®•à®µà®¿à®¤à¯ˆ`,
        `à®‰à®©à¯ à®ªà¯à®©à¯à®©à®•à¯ˆ à®¤à®¨à¯à®¤ à®ªà¯à®¤à¯ à®µà¯†à®³à®¿à®šà¯à®šà®®à¯`,
        `[Verse 1]`,
        `à®•à®©à®µà¯†à®²à¯à®²à®¾à®®à¯ à®¨à®©à®µà®¾à®•à¯à®®à¯ à®‡à®¨à¯à®¤ à®¨à¯Šà®Ÿà®¿`,
        `à®Žà®©à¯ à®ªà®¾à®¤à¯ˆà®¯à¯†à®²à¯à®²à®¾à®®à¯ à®‰à®©à¯ à®•à®¾à®²à¯ à®¤à®Ÿà®®à¯`,
        `[Bridge]`,
        `${title} à®‡à®šà¯ˆ à®…à®²à¯ˆà®•à®³à¯ à®µà¯€à®šà¯à®¤à¯ à®Žà®™à¯à®•à¯à®®à¯`,
        `[Outro: ${artist} - Album: ${album}]`,
        `â™ª à®®à®±à®•à¯à®• à®®à¯à®Ÿà®¿à®¯à®¾à®¤ à®‡à®©à®¿à®®à¯ˆà®¯à®¾à®© à®°à®¾à®•à®®à¯ â™ª`
      ];
    } else if (lang.includes('punjabi') || cat === 'punjabi') {
      lines = [
        `[Intro: ${artist}]`,
        `â™ª ${title} - Desi Vibe Official â™ª`,
        ...
        `[Outro: ${artist} - Album: ${album}]`,
        `â™ª Winning Speech & Endless Vibes â™ª`
      ];
    } else if (lang.includes('devotional') || cat === 'devotional') {
      lines = [
        `[Mangalacharan: ${artist}]`,
        `à¥¥ à¥ à¤¶à¥à¤°à¥€ à¤ªà¤°à¤®à¤¾à¤¤à¥à¤®à¤¨à¥‡ à¤¨à¤®à¤ƒ à¥¥`,
        `â™ª ${title} - à¤¦à¤¿à¤µà¥à¤¯ à¤­à¤•à¥à¤¤à¤¿ à¤°à¤¸ à¤§à¤¾à¤°à¤¾ â™ª`,
        `à¤šà¤°à¤£ à¤•à¤®à¤² à¤®à¥‡à¤‚ à¤¶à¥€à¤¶ à¤à¥à¤•à¤¾à¤Šà¤‚`,
        `à¤ªà¥à¤°à¤­à¥ à¤•à¥‡ à¤šà¤°à¤£à¥‹à¤‚ à¤®à¥‡à¤‚ à¤§à¥à¤¯à¤¾à¤¨ à¤²à¤—à¤¾à¤Šà¤‚`,
        `[Stuti / Chorus]`,
        `${title} à¤®à¤‚à¤—à¤²à¤•à¤¾à¤°à¥€ à¤¶à¥à¤­ à¤«à¤² à¤¦à¤¾à¤¤à¤¾`,
        `à¤¦à¥à¤– à¤­à¤‚à¤œà¤¨ à¤†à¤¨à¤‚à¤¦ à¤•à¥‡ à¤¸à¤¾à¤—à¤°`,
        `à¤•à¥ƒà¤ªà¤¾ à¤¦à¥ƒà¤·à¥à¤Ÿà¤¿ à¤…à¤ªà¤¨à¥€ à¤¬à¤¨à¤¾à¤ à¤°à¤–à¤¨à¤¾`,
        `[Doha / Verse 1]`,
        `à¤­à¤•à¥à¤¤à¤¿ à¤­à¤¾à¤µ à¤¸à¥‡ à¤œà¥‹ à¤•à¥‹à¤ˆ à¤—à¤¾à¤µà¥‡`,
        `à¤®à¤¨à¤µà¤¾à¤‚à¤›à¤¿à¤¤ à¤«à¤² à¤¸à¥‹ à¤ªà¤¾à¤µà¥‡`,
        `[Aarti & Prarthana]`,
        `${title} à¤•à¥€ à¤®à¤¹à¤¿à¤®à¤¾ à¤…à¤ªà¤°à¤‚à¤ªà¤¾à¤°`,
        `[Outro: ${artist} - Album: ${album}]`,
        `à¥¥ à¤œà¤¯ à¤¶à¥à¤°à¥€ à¤°à¤¾à¤® â€¢ à¥ à¤¨à¤®à¤ƒ à¤¶à¤¿à¤µà¤¾à¤¯ â€¢ à¤°à¤¾à¤§à¥‡ à¤°à¤¾à¤§à¥‡ à¥¥`
      ];
    } else if (lang.includes('english') || cat === 'pop') {
      lines = [
        `[Intro: ${artist}]`,
        `â™ª ${title} - Studio Master Stream â™ª`,
        ...
        `[Outro: ${artist} - Album: ${album}]`,
        `â™ª High-Fidelity Pulse Master Edition â™ª`
      ];
    } else {
      // Hindi / Bollywood default
      lines = [
        `[Intro: ${artist}]`,
        `â™ª ${title} - à¤®à¥‡à¤²à¥‹à¤¡à¤¿à¤¯à¤¸ à¤¸à¤¾à¤‰à¤‚à¤¡à¤Ÿà¥à¤°à¥ˆà¤• â™ª`,
        `à¤¦à¤¿à¤² à¤•à¥€ à¤—à¤¹à¤°à¤¾à¤‡à¤¯à¥‹à¤‚ à¤¸à¥‡ à¤¨à¤¿à¤•à¤²à¥€ à¤¸à¤¦à¤¾`,
        `à¤¤à¥‡à¤°à¥€ à¤®à¥‹à¤¹à¤¬à¥à¤¬à¤¤ à¤•à¤¾ à¤¯à¥‡ à¤•à¥ˆà¤¸à¤¾ à¤…à¤¸à¤° à¤¹à¥à¤†`,
        `[Chorus]`,
        `${title} à¤®à¥‡à¤‚ à¤–à¥‹à¤¯à¤¾ à¤¹à¥ˆ à¤¯à¥‡ à¤¦à¤¿à¤² à¤®à¥‡à¤°à¤¾`,
        `à¤¤à¥‡à¤°à¥‡ à¤¬à¤¿à¤¨à¤¾ à¤¸à¥‚à¤¨à¤¾ à¤¹à¥ˆ à¤¹à¤° à¤à¤• à¤°à¤¾à¤¸à¥à¤¤à¤¾`,
        `à¤†à¤‚à¤–à¥‹à¤‚ à¤®à¥‡à¤‚ à¤¬à¤¸à¥€ à¤¹à¥ˆ à¤¤à¥‡à¤°à¥€ à¤¹à¥€ à¤¸à¥‚à¤°à¤¤`,
        `[Verse 1]`,
        `à¤šà¤¾à¤‚à¤¦à¤¨à¥€ à¤°à¤¾à¤¤à¥‹à¤‚ à¤®à¥‡à¤‚ à¤¤à¥‡à¤°à¥€ à¤¹à¥€ à¤¯à¤¾à¤¦à¥‡à¤‚`,
        `à¤¹à¤µà¤¾à¤“à¤‚ à¤®à¥‡à¤‚ à¤—à¥‚à¤‚à¤œà¥‡ à¤¤à¥‡à¤°à¥€ à¤¹à¥€ à¤¬à¤¾à¤¤à¥‡à¤‚`,
        `[Bridge]`,
        `${title} à¤•à¤¾ à¤¯à¥‡ à¤ªà¥à¤¯à¤¾à¤°à¤¾ à¤¤à¤°à¤¾à¤¨à¤¾`,
        `à¤§à¤¡à¤¼à¤•à¤¨à¥‹à¤‚ à¤•à¥‹ à¤¦à¥‡ à¤—à¤¯à¤¾ à¤¨à¤¯à¤¾ à¤…à¤«à¤¼à¤¸à¤¾à¤¨à¤¾`,
        `[Outro: ${artist} - Album: ${album}]`,
        `â™ª à¤¸à¤‚à¤—à¥€à¤¤ à¤•à¥€ à¤–à¥‚à¤¬à¤¸à¥‚à¤°à¤¤ à¤¦à¤¾à¤¸à¥à¤¤à¤¾à¤¨ â™ª`
      ];
    }
  ...
  function renderLyricsDrawer() {
    ...
    const badgeLabel = isVerified ? 'âœ¨ Verified Synced Lyrics' : 'ðŸŽ™ï¸ Synchronized Karaoke Lyrics Preview';
